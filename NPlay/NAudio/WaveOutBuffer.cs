...
namespace NSox.NAudio
{
    ...
    class WaveOutBuffer : IDisposable
    {
        ...
        public WaveOutBuffer(IntPtr hWaveOut, Int32 bufferSize, IWaveProvider bufferFillStream, object waveOutLock)
        {
            ...
            lock (waveOutLock)
            {
                MmException.Try(WaveInterop.waveOutPrepareHeader(hWaveOut, header, Marshal.SizeOf(header)), Def.WaveOutPrepare);
            }
        }
        ...
        {
            Dispose(false);
            System.Diagnostics.Debug.Assert(true, Def.WaveBufferNotDisposed);
        }
        ...
        private void WriteToWaveOut()
        {
            ...
            {
                throw new MmException(result, Def.WaveOutWrite);
            }
