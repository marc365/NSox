...
namespace NSox.NAudio
{
    ...
    public class WaveOut : IWavePlayer
    {
        ...
        internal WaveOut(WaveCallbackInfo callbackInfo)
        {
            ...
            this.DeviceNumber = 0;
            this.DesiredLatency = Def.Latency;
        ...
        public void Init(IWaveProvider waveProvider)
        {
            ...
            MmException.Try(result, Def.WaveOutOpen);
        ...
        public void Play()
        {
            if (playbackState == PlaybackState.Stopped)
            {
                ...
                Debug.Assert(queuedBuffers == 0, Def.BuffersAlreadyQueued);
                EnqueueBuffers();
            }
        }
        ...
        public void Stop()
        {
            if (playbackState != PlaybackState.Stopped)
            {
                ...
                {
                    throw new MmException(result, Def.WaveOutReset);
                }
        ...
        public float Volume
        {
            ...
            set
            {
                if (value < 0 || value > 1) throw new ArgumentOutOfRangeException(Def.VolumeRange);
                volume = value;
                float left = volume;
                float right = volume;
                ...
                MmException.Try(result, Def.WaveOutSetVolume);
            }
        }
        ...
        ~WaveOut()
        {
            System.Diagnostics.Debug.Assert(false, Def.WaveOutNotClosed);
            Dispose(false);
        }
